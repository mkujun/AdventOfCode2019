...
namespace Day5
{
    ...
    public class IntcodeComputer
    {
        ...
        public void Ins5(Tuple<int,int> first, Tuple<int,int> second)
        {
            Tuple<int, int> modeParameters = DefineMode(first, second);

            if (modeParameters.Item1 != 0)
            {
                Pointer = modeParameters.Item2;
                TEST(Pointer);
            }
            else
                TEST(Pointer + 3);
        }
        public void Ins6(Tuple<int, int> first, Tuple<int, int> second)
        {
            Tuple<int, int> modeParameters = DefineMode(first, second);
        ...
        public void Ins7(Tuple<int, int> first, Tuple<int, int> second, int destination)
        {
            Tuple<int, int> modeParameters = DefineMode(first, second);

            if (modeParameters.Item1 < modeParameters.Item2)
                Data[destination] = 1;
            else
                Data[destination] = 0;
        ...
        public void Ins8(Tuple<int, int> first, Tuple<int, int> second, int destination)
        {
            Tuple<int, int> modeParameters = DefineMode(first, second);
        ...
        public void ParameterMode(int instruction, int firstParameter, int secondParameter, int destination)
        {
            ...
            switch (keyValuePairs["E"])
            {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    Ins5(new Tuple<int, int>(keyValuePairs["C"], firstParameter), new Tuple<int, int>(keyValuePairs["B"], secondParameter));
                    break;
                case 6:
                    Ins6(new Tuple<int, int>(keyValuePairs["C"], firstParameter), new Tuple<int, int>(keyValuePairs["B"], secondParameter));
                    break;
                case 7:
                    Ins7(new Tuple<int, int>(keyValuePairs["C"], firstParameter), new Tuple<int, int>(keyValuePairs["B"], secondParameter), destination);
                    break;
                case 8:
                    Ins8(new Tuple<int, int>(keyValuePairs["C"], firstParameter), new Tuple<int, int>(keyValuePairs["B"], secondParameter), destination);
                    break;
                default:
                    break;
            }
        ...
        public void TEST(int pointer)
        {
            ...
            switch (Data[Pointer])
            {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    Ins5(new Tuple<int, int>(0, Data[Pointer + 1]), new Tuple<int, int>(0, Data[Pointer + 2]));
                    break;
                case 6:
                    Ins6(new Tuple<int, int>(0, Data[Pointer + 1]), new Tuple<int, int>(0, Data[Pointer + 2]));
                    break;
                case 7:
                    Ins7(new Tuple<int, int>(0, Data[Pointer + 1]), new Tuple<int, int>(0, Data[Pointer + 2]), Data[Pointer + 3]);
                    break;
                case 8:
                    Ins8(new Tuple<int, int>(0, Data[Pointer + 1]), new Tuple<int, int>(0, Data[Pointer + 2]), Data[Pointer + 3]);
                    break;
                case 99:
                    break;
                default:
    ...
    class Program
    {
        ...
        {
            // input "1" => Air conditioner
            // input "5" => Thermal radiators
